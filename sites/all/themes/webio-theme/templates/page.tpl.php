...
<div id="page" class="container <?php print $classes; ?>">
  ...
  <!--  Abobe Tertiary Section-->
  <?php if($above_tertiaty = render($page['above_tertiary'])) : ?>
      <div id="above-tertiary" class="region clearfix">
        <?php print $above_tertiaty; ?>
      </div>
  <?php endif ?>

  <!--  News Section-->
  <?php if($news_section = render($page['news_section'])) : ?>
    <div id="news-section" class="region clearfix">
      <?php print $news_section; ?>
    </div>
  <?php endif ?>
